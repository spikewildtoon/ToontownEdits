...
class EstateLoader(SafeZoneLoader.SafeZoneLoader):
    ...
    def __init__(self, hood, parentFSM, doneEvent):
        ...
        self.musicFile = 'phase_4/audio/bgm/EstateTheme.ogg'
    ...
    def load(self):
        ...
        self.music = base.loadMusic('phase_4/audio/bgm/EstateTheme.ogg')
    ...
    def enter(self, requestStatus):
        ...
        base.playMusic(self.music.play(), looping=1, volume=volume)
